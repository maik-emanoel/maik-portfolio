  ...
  return (
    <>
      <HeaderButtons
        ...
        } right-[24px] border border-slate-200 dark:border-slate-500 py-2 px-3 rounded-full bg-background/5 backdrop-blur-lg z-50 transition-transform duration-300 shadow`}
      />
    </>
  );
}
